...
module.exports = __webpack_require__("PMv2");
...
// CONCATENATED MODULE: ./components/Discover.js
...
class Discover_Discover extends external_react_["Component"] {
  ...
  render() {
    ...
    }, __jsx(dist["c" /* BrowseFeatured */], null, (playlists, loading, error) => playlists ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
      className: discover_module_default.a.contentCoverList
    }, playlists.playlists.items.map((playlist, index) => __jsx("div", {
      key: index,
    ...
    }), __jsx(dist["c" /* BrowseFeatured */], null, (playlists, loading, error) => playlists ? __jsx(external_react_default.a.Fragment, null, __jsx(dist["d" /* Playlist */], {
...
/* harmony default export */ var components_Discover = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Discover_Discover));
// CONCATENATED MODULE: ./pages/Discover.js
...
class pages_Discover_Discover extends external_react_["Component"] {
  constructor(props) {
    super(props);

    Discover_defineProperty(this, "handleIndex", index => {
      this.setState({
        index
      });
    });
  ...
  render() {
    ...
    return Discover_jsx("div", {
      className: "content"
    }, this.state.token ? Discover_jsx(dist["e" /* SpotifyApiAxiosContext */].Provider, {
      value: $axios["a" /* default */]
    }, Discover_jsx(dist["f" /* SpotifyApiContext */].Provider, {
      value: this.state.token
    }, Discover_jsx("div", {
      className: "content-header"
    }, "Discover"), Discover_jsx(components_Discover, null))) : null);
  }

}

const Discover_mapStateToProps = state => {
  return {
...
const Discover_mapDispatchToProps = dispatch => {
  return {
...
/* harmony default export */ var pages_Discover = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(Discover_mapStateToProps, Discover_mapDispatchToProps)(pages_Discover_Discover));
