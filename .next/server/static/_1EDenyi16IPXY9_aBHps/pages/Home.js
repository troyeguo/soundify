...
class Home_Home extends external_react_["Component"] {
  ...
  render() {
    return __jsx("div", null, __jsx("div", {
      className: home_module_default.a.coverParent
    }, __jsx("div", {
      className: home_module_default.a.contentCoverContainer,
      onClick: () => {
        this.handleClick(0);
      }
    }, __jsx("div", {
      className: home_module_default.a.contentTitle
    }, "All Songs"), this.state.index === 0 ? __jsx("div", {
      className: home_module_default.a.contentSelector
    }) : null), __jsx("div", {
      className: home_module_default.a.contentCoverContainer,
      onClick: () => {
        this.handleClick(1);
      ...
      className: home_module_default.a.contentLine
    }), __jsx("ul", {
      className: home_module_default.a.contentListContainer
    }, __jsx("div", {
      className: home_module_default.a.songListContainer
    }, this.state.index === 1 ? __jsx("div", null, this.props.tracks.map((track, index) => __jsx("li", {
      key: track.played_at,
      className: home_module_default.a.contentList,
      onMouseOver: () => {
      ...
      className: home_module_default.a.indexName
    }, index + 1), this.state.hoverIndex === index ? __jsx("img", {
      src: "/icons/play.svg",
      alt: "",
      className: home_module_default.a.listPlayIcon,
      onClick: () => this.playSongHandler(track.track, "test")
    }) : __jsx("img", {
      src: "/icons/favorite.svg",
      alt: "",
      className: home_module_default.a.favoriteIcon
    }), __jsx("div", {
      className: home_module_default.a.trackName
    }, track.track.name), __jsx("div", {
      className: home_module_default.a.trackArtist
    }, track.track.artists[0].name), __jsx("div", {
      className: home_module_default.a.trackAlbum
    }, track.track.album.name), __jsx("img", {
      src: "/icons/more_dot.svg",
      alt: "",
      className: home_module_default.a.moreDot
    })))) : __jsx(dist["j" /* UserTracks */], null, tracks => tracks ? __jsx("div", null, tracks.items.map((track, index) => __jsx("li", {
      key: track.track.id,
      className: home_module_default.a.contentList,
      onMouseOver: () => {
        this.handleIndex(index);
...
class pages_Home_Home extends external_react_["Component"] {
  constructor(props) {
    super(props);

    Home_defineProperty(this, "handleIndex", index => {
      this.setState({
        index
      });
    });
  ...
  render() {
    ...
    return Home_jsx("div", {
      className: "content"
    }, this.state.token ? Home_jsx(dist["e" /* SpotifyApiAxiosContext */].Provider, {
      value: $axios["a" /* default */]
    }, Home_jsx(dist["f" /* SpotifyApiContext */].Provider, {
      value: this.state.token
    }, Home_jsx("div", {
      className: "content-header"
    }, "Home"), Home_jsx(components_Home, {
...
/* harmony default export */ var pages_Home = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(Home_mapStateToProps, Home_mapDispatchToProps)(pages_Home_Home));
