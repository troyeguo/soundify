...
module.exports = __webpack_require__("axep");
...
// CONCATENATED MODULE: ./components/Playlists.js
...
class Playlists_PlaylistComp extends external_react_["Component"] {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    }, __jsx(dist["i" /* UserPlaylists */], null, (playlists, loading, error) => playlists ? __jsx(external_react_default.a.Fragment, null, __jsx("div", {
    ...
    }), __jsx(dist["i" /* UserPlaylists */], null, (playlists, loading, error) => playlists ? __jsx(external_react_default.a.Fragment, null, __jsx(dist["d" /* Playlist */], {
...
/* harmony default export */ var Playlists = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Playlists_PlaylistComp));
// CONCATENATED MODULE: ./pages/Playlist.js
var Playlist_jsx = external_react_default.a.createElement;
...
class Playlist_Playlist extends external_react_["Component"] {
  constructor(props) {
    super(props);

    Playlist_defineProperty(this, "handleIndex", index => {
      this.setState({
        index
      });
    });
  ...
  render() {
    ...
    return Playlist_jsx("div", {
      className: "content"
    }, this.state.token ? Playlist_jsx(dist["e" /* SpotifyApiAxiosContext */].Provider, {
      value: $axios["a" /* default */]
    }, Playlist_jsx(dist["f" /* SpotifyApiContext */].Provider, {
      value: this.state.token
    }, Playlist_jsx("div", {
      className: "content-header"
    }, "Playlist"), Playlist_jsx(Playlists, null))) : null);
  }

}

const Playlist_mapStateToProps = state => {
  return {};
};

const Playlist_mapDispatchToProps = dispatch => {
  return {
...
/* harmony default export */ var pages_Playlist = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(Playlist_mapStateToProps, Playlist_mapDispatchToProps)(Playlist_Playlist));
