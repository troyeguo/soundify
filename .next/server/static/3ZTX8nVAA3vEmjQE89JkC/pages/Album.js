...
module.exports = __webpack_require__("1Gv8");
...
class Album_Album extends external_react_["Component"] {
  constructor(props) {
    super(props);
  ...
  render() {
    return __jsx("div", null, __jsx("div", {
    ...
    }, __jsx(dist["g" /* UserAlbums */], null, (albums, loading, error) => albums && __jsx("div", {
    ...
    }), __jsx(dist["g" /* UserAlbums */], null, (albums, loading, error) => albums ? __jsx(external_react_default.a.Fragment, null, __jsx(dist["a" /* AlbumTracks */], {
      ...
      onClick: () => this.playSongHandler(track, albums.items[this.state.currentIndex].album)
    }) : __jsx("img", {
...
/* harmony default export */ var components_Album = (Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(Album_Album));
...
class pages_Album_Album extends external_react_["Component"] {
  constructor(props) {
    super(props);

    Album_defineProperty(this, "handleIndex", index => {
      this.setState({
        index
      });
    });
  ...
  render() {
    ...
    return Album_jsx("div", {
      className: "content"
    }, this.state.token ? Album_jsx(dist["e" /* SpotifyApiAxiosContext */].Provider, {
      value: $axios["a" /* default */]
    }, Album_jsx(dist["f" /* SpotifyApiContext */].Provider, {
      value: this.state.token
    }, Album_jsx("div", {
      className: "content-header"
    }, "Album"), Album_jsx(components_Album, null))) : null);
  }

}

const Album_mapStateToProps = state => {
  return {
...
const Album_mapDispatchToProps = dispatch => {
  return {
...
/* harmony default export */ var pages_Album = __webpack_exports__["default"] = (Object(external_react_redux_["connect"])(Album_mapStateToProps, Album_mapDispatchToProps)(Object(router_["withRouter"])(pages_Album_Album)));
